...
public class SqlHelper
{
        ...
        {
            return ExecuteNonQuery(SqlHelper.connStr, CommandType.Text, commandText, paras);
        }
        ...
        {
            return ExecuteScalar(SqlHelper.connStr, CommandType.Text, commandText);
        }

        public static object ExecuteScalar(string commandText, params SqlParameter[] paras)
        {
            return ExecuteScalar(SqlHelper.connStr, CommandType.Text, commandText, paras);
        }
        ...
        public static DataTable GetDataTableBySQL(string sql ,params object[] objs)
        {
            DataTable dt = SqlHelper.GetDataTable(SqlHelper.connStr, CommandType.Text, string.Format(sql,objs), null);
            return dt;
        }
     
       public static int ExeSql(string sql,params object [] pars)
       {
           return SqlHelper.ExecuteNonQuery(SqlHelper.connStr, CommandType.Text, string.Format(sql, pars), null);
